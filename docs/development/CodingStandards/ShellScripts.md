...
These guidelines prescribe the standard shebangs, fail-fast execution parameters, variable expansions, and main function modular structures required for all Bash and POSIX shell scripts in the repository.

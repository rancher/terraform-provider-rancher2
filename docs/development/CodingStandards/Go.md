...
These guidelines prescribe the standard Go (Golang) coding style, explicit error handling/wrapping practices, context propagation, and network timeout handling enforced across all provider Go components.
...
- **Stand-alone Module:** The `./test` directory should be a stand-alone Go module named `test`.

...
function main() {
  ...
  try {
    ...
    console.error('Failed to parse stdin JSON in 02-plan-phase:', err.message || err);
    console.log(
      JSON.stringify({
        decision: 'deny',
        reason: '🔒 Security Policy Violation: Failed to parse input payload in 02-plan-phase hook.',

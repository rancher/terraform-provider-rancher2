...
* Add user principal id to global role binding ([#2252](https://github.com/rancher/terraform-provider-rancher2/issues/2252))
...
* add refresh_interval support to catalog_v2 ([#2202](https://github.com/rancher/terraform-provider-rancher2/issues/2202)) ([e956610](https://github.com/rancher/terraform-provider-rancher2/commit/e95661047788b48bfc6a05a92c8fb2a69def9a8a))
...
* add s3 retention config for etcd snapshots ([#2402](https://github.com/rancher/terraform-provider-rancher2/issues/2402)) ([1730d97](https://github.com/rancher/terraform-provider-rancher2/commit/1730d977ad2c12d51830d4b1c0ba55776f1e1f9d))
* add skip_schema_validation to app_v2 ([#2294](https://github.com/rancher/terraform-provider-rancher2/issues/2294)) ([#2298](https://github.com/rancher/terraform-provider-rancher2/issues/2298)) ([b1f8bd7](https://github.com/rancher/terraform-provider-rancher2/commit/b1f8bd7acce74cef20235ce9b2b4a29536f7d04f))
* add use internal certs option for local auth endpoint in cluster v2 ([#1626](https://github.com/rancher/terraform-provider-rancher2/issues/1626)) ([#2301](https://github.com/rancher/terraform-provider-rancher2/issues/2301)) ([3e1899c](https://github.com/rancher/terraform-provider-rancher2/commit/3e1899c7bf2cdc687d224e8779a0b204bf835083))
* Add user principal id to global role binding ([#2252](https://github.com/rancher/terraform-provider-rancher2/issues/2252)) ([84dc033](https://github.com/rancher/terraform-provider-rancher2/commit/84dc033118ca29ff93f1d94dca095036bf2bd65a))
...
* Expose the OIDC Client secret. ([#2349](https://github.com/rancher/terraform-provider-rancher2/issues/2349)) ([#2373](https://github.com/rancher/terraform-provider-rancher2/issues/2373)) ([97a08e3](https://github.com/rancher/terraform-provider-rancher2/commit/97a08e3a24e58686d29106012ed572a3f18efc36))
...
* OIDC Client validation ([#2352](https://github.com/rancher/terraform-provider-rancher2/issues/2352)) ([#2372](https://github.com/rancher/terraform-provider-rancher2/issues/2372)) ([8d07bdd](https://github.com/rancher/terraform-provider-rancher2/commit/8d07bdd3565d3538e2430b71e5c765ff81f5b7a2))
* Support OIDC Provider OIDC Clients ([#2147](https://github.com/rancher/terraform-provider-rancher2/issues/2147)) ([#2270](https://github.com/rancher/terraform-provider-rancher2/issues/2270)) ([fc9497f](https://github.com/rancher/terraform-provider-rancher2/commit/fc9497f0a7b3ca93978880fa6e06f2cf41fb889c))
* Support Openstack Server Groups affinity ([#2223](https://github.com/rancher/terraform-provider-rancher2/issues/2223)) ([fc9cf47](https://github.com/rancher/terraform-provider-rancher2/commit/fc9cf47d8920284a8d6a8628bc2afb01e2dd80cf))
...
* Add the inherited-namespaced-rules field to globalroles ([#2340](https://github.com/rancher/terraform-provider-rancher2/issues/2340)) ([#2417](https://github.com/rancher/terraform-provider-rancher2/issues/2417)) ([7e8baeb](https://github.com/rancher/terraform-provider-rancher2/commit/7e8baebdaca85ebd1cef64e43e5359eed861d725))
* Backport 2208 to v15 ([#2213](https://github.com/rancher/terraform-provider-rancher2/issues/2213)) ([296c351](https://github.com/rancher/terraform-provider-rancher2/commit/296c3519cdcaafbecf633eef7667d3441c423967))
* Backport 2238 v15 ([#2247](https://github.com/rancher/terraform-provider-rancher2/issues/2247)) ([7892188](https://github.com/rancher/terraform-provider-rancher2/commit/7892188be8ee397ca5bad0effce98469f2ec2ffe))
* backport the release process ([#2475](https://github.com/rancher/terraform-provider-rancher2/issues/2475)) ([4f45686](https://github.com/rancher/terraform-provider-rancher2/commit/4f456863f37a63cfe13d438a91af4b47b8c718ba))
...
* Bump Go dependencies and Go version. ([#2278](https://github.com/rancher/terraform-provider-rancher2/issues/2278)) ([#2286](https://github.com/rancher/terraform-provider-rancher2/issues/2286)) ([3f4f3ad](https://github.com/rancher/terraform-provider-rancher2/commit/3f4f3ada8f0036ff36c265e4d7e742f513ed4f23))
...
* clean up nix install script ([#2230](https://github.com/rancher/terraform-provider-rancher2/issues/2230)) ([#2235](https://github.com/rancher/terraform-provider-rancher2/issues/2235)) ([70d4e05](https://github.com/rancher/terraform-provider-rancher2/commit/70d4e0566cb46d39d2be10e2542712ab68d813f1))
...
* Docs Add name space variable to kubeconfig command ([#2226](https://github.com/rancher/terraform-provider-rancher2/issues/2226)) ([222d5a8](https://github.com/rancher/terraform-provider-rancher2/commit/222d5a8f5946711310253bc75acc018360da4099))
...
* Fix removal of deployment configuration on imported clusters ([#2244](https://github.com/rancher/terraform-provider-rancher2/issues/2244)) ([#2322](https://github.com/rancher/terraform-provider-rancher2/issues/2322)) ([b4d4114](https://github.com/rancher/terraform-provider-rancher2/commit/b4d41140c31f8a2fa403dff38c2db2eefefd384b))
* Fix typo in rancher2_cluster public_access_sources docs ([#2229](https://github.com/rancher/terraform-provider-rancher2/issues/2229)) ([4865835](https://github.com/rancher/terraform-provider-rancher2/commit/486583528661a93012addc3cd3d9ea3edb354275))
...
* release as v15.0.0 ([#2243](https://github.com/rancher/terraform-provider-rancher2/issues/2243)) ([46ef025](https://github.com/rancher/terraform-provider-rancher2/commit/46ef025446f5eb54d9d174c46f30de1518310341))
* release as v15.1.1 ([#2478](https://github.com/rancher/terraform-provider-rancher2/issues/2478)) ([8a3053f](https://github.com/rancher/terraform-provider-rancher2/commit/8a3053f7cfe5319c70ed7cf5f54845b8be101a56))
* release as v15.1.2 ([#2482](https://github.com/rancher/terraform-provider-rancher2/issues/2482)) ([0bf72dc](https://github.com/rancher/terraform-provider-rancher2/commit/0bf72dcfca907768f38accf31cc0cd1f86ce75ba))
...
* remove rke1 dependency ([#2289](https://github.com/rancher/terraform-provider-rancher2/issues/2289)) ([#2297](https://github.com/rancher/terraform-provider-rancher2/issues/2297)) ([415c7ab](https://github.com/rancher/terraform-provider-rancher2/commit/415c7abeab854cdbf7612e7ac7a79a94f3b10d14))
...
* resolve user_principal_id to user_id on global role binding create ([#2366](https://github.com/rancher/terraform-provider-rancher2/issues/2366)) ([#2416](https://github.com/rancher/terraform-provider-rancher2/issues/2416)) ([9434405](https://github.com/rancher/terraform-provider-rancher2/commit/943440541b8e93e2489e3c503a21a82b9fc053d8))
* Revert "feat: support using internal certs for the local auth endpoint" ([#1626](https://github.com/rancher/terraform-provider-rancher2/issues/1626)) ([#2440](https://github.com/rancher/terraform-provider-rancher2/issues/2440)) ([#2445](https://github.com/rancher/terraform-provider-rancher2/issues/2445)) ([c85328c](https://github.com/rancher/terraform-provider-rancher2/commit/c85328cb765e5f15c63e345ed35ad2ab2431d1fb))
...
* skip publish if it is already published ([#2480](https://github.com/rancher/terraform-provider-rancher2/issues/2480)) ([32a2781](https://github.com/rancher/terraform-provider-rancher2/commit/32a2781932b39b018e56c41de27807e921614bfb))
* Stop data sources from generating kubeconfig tokens on every plan ([#2269](https://github.com/rancher/terraform-provider-rancher2/issues/2269)) ([#2287](https://github.com/rancher/terraform-provider-rancher2/issues/2287)) ([8f0c51c](https://github.com/rancher/terraform-provider-rancher2/commit/8f0c51c5ec6becf84c18a64c313884658c24a4c1))
...
* update default token TTL to match Rancher ([#2220](https://github.com/rancher/terraform-provider-rancher2/issues/2220)) ([23d0c85](https://github.com/rancher/terraform-provider-rancher2/commit/23d0c8523d63389894f8bc5e7729d1fff0d8385a))
* update docs on app_v2 import ([#2317](https://github.com/rancher/terraform-provider-rancher2/issues/2317)) ([#2329](https://github.com/rancher/terraform-provider-rancher2/issues/2329)) ([45f8156](https://github.com/rancher/terraform-provider-rancher2/commit/45f815675ae75a34407eaec27c7017e5bba9be82))
...
## [15.1.1](https://github.com/rancher/terraform-provider-rancher2/compare/v15.1.1...v15.1.1) (2026-09-10)

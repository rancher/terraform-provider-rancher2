...
func clusterResourceQuotaLimitFields() map[string]*schema.Schema {
...
func flattenClusterResourceQuotaLimit(in *clusterClient.ResourceQuotaLimit) ([]interface{}, error) {
...
func expandClusterResourceQuotaLimit(p []interface{}) (*clusterClient.ResourceQuotaLimit, error) {

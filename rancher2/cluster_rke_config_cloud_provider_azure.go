...
func flattenAzureCloudProvider(in *managementClient.AzureCloudProvider) ([]interface{}, error) {
...
func expandAzureCloudProvider(p []interface{}) (*managementClient.AzureCloudProvider, error) {

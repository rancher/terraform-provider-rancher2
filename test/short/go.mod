module github.com/rancher/terraform-provider-rancher2/test/short

go 1.26

require github.com/hashicorp/terraform-plugin-framework v1.19.0

replace github.com/rancher/terraform-provider-rancher2 => ../../../terraform-provider-rancher2

require (
	github.com/hashicorp/terraform-plugin-go v0.31.0
	github.com/rancher/terraform-provider-rancher2 v1.25.0
)

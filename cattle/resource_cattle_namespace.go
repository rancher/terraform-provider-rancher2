...
func init() {
	descriptions = map[string]string{
		"name": "Name of the k8s namespace managed by cattle",

		"cluster_id": "Cluster ID where k8s namespace belongs",

		"project_name": "Project name where k8s namespace belongs",

		"description": "Description of the k8s namespace managed by cattle",

		"annotations": "Annotations of the k8s namespace managed by cattle",

		"labels": "Labels of the k8s namespace managed by cattle",
	}
}
